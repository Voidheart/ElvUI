...
local function UpdateColor(self, event, unit)
	...
	elseif
		element.colorTapping
		and not UnitPlayerControlled(unit)
		and (UnitIsTapped(unit) and not UnitIsTappedByPlayer(unit) and not UnitIsTappedByAllThreatList(unit))
	then
...
local function Enable(self, unit)
	...
	if element then
		...
		if element:IsObjectType("StatusBar") then
			element.texture = element:GetStatusBarTexture() and element:GetStatusBarTexture():GetTexture()
