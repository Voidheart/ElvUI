...
assert(
	oUF,
	"oUF_Fader cannot find an instance of oUF. If your oUF is embedded into a layout, it may not be embedded properly."
)
...
local function Update(self, _, unit)
	...
	if
		(element.Casting and (UnitCastingInfo(unit) or UnitChannelInfo(unit)))
