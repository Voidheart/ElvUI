...
S:AddCallback("Skin_Loot", function()
	...
	if not E.private.skins.blizzard.enable or not E.private.skins.blizzard.loot then
		return
	end
...
S:AddCallback("Skin_LootRoll", function()
	...
	if not E.private.skins.blizzard.enable or not E.private.skins.blizzard.lootRoll then
		return
	end
