...
local function OnEnter(self)
	...
	if E.Role == "Caster" then
		...
		if E.myclass == "HUNTER" then
			...
			tooltip =
				format(CR_CRIT_RANGED_TOOLTIP, GetCombatRating(CR_CRIT_RANGED), GetCombatRatingBonus(CR_CRIT_RANGED))
		else
...
DT:RegisterDatatext(
	"Crit Chance",
	{ "SPELL_UPDATE_USABLE", "ACTIVE_TALENT_GROUP_CHANGED", "PLAYER_TALENT_UPDATE", "PLAYER_DAMAGE_DONE_MODS" },
	OnEvent,
	nil,
	nil,
	OnEnter,
