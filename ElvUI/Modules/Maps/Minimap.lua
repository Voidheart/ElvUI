...
function M:Update_ZoneText()
	...
	Minimap.location:FontTemplate(
		E.Libs.LSM:Fetch("font", E.db.general.minimap.locationFont),
		E.db.general.minimap.locationFontSize,
		E.db.general.minimap.locationFontOutline
	)
end
...
function M:CreateFarmModeMap()
	...
	fm:SetMovable(true)
	fm:SetScript("OnDragStart", function(self)
		self:StartMoving()
	end)
	fm:SetScript("OnDragStop", function(self)
...
function M:UpdateSettings()
	...
	if MMHolder then
		...
		if E.db.datatexts.minimapPanels then
			MMHolder:Height(
				Minimap:GetHeight() + (LeftMiniPanel and (LeftMiniPanel:GetHeight() + E.Border) or 24) + E.Spacing * 3
			)
		else
	...
	if GameTimeFrame then
		if E.private.general.minimap.hideCalendar then
			...
			GameTimeFrame:Point(
				...
				Minimap,
				pos,
				E.db.general.minimap.icons.calendar.xOffset or 0,
	...
	if MiniMapMailFrame then
		...
		MiniMapMailFrame:Point(
			pos,
			Minimap,
			pos,
			E.db.general.minimap.icons.mail.xOffset or 3,
	...
	if MiniMapLFGFrame then
		...
		MiniMapLFGFrame:Point(
			pos,
			Minimap,
			pos,
			E.db.general.minimap.icons.lfgEye.xOffset or 3,
	...
	if MiniMapBattlefieldFrame then
		...
		MiniMapBattlefieldFrame:Point(
			pos,
			Minimap,
			pos,
			E.db.general.minimap.icons.battlefield.xOffset or 3,
