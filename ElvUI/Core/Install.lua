...
function E:SetupTheme(theme, noDisplayMsg)
	...
	elseif theme == "class" then
		classColor = E.myclass == "PRIEST" and E.PriestColors
...
local function SetPage(PageNum)
	...
	elseif PageNum == 6 then
		...
		InstallOption2Button:SetScript("OnClick", function()
			E.db.layoutSet = nil
			E:SetupLayout("healer")
		end)
		InstallOption2Button:SetText(L["Healer"])
		InstallOption3Button:Show()
		InstallOption3Button:SetScript("OnClick", function()
			E.db.layoutSet = nil
			E:SetupLayout("dpsCaster")
		end)
	...
	elseif PageNum == 8 then
		...
		InstallOption1Button:Show()
		InstallOption1Button:SetScript("OnClick", function()
			E:StaticPopup_Show("ELVUI_EDITBOX", nil, nil, "https://discord.gg/UXSc7nt")
		end)
