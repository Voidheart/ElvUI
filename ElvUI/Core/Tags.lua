...
for textFormat in pairs(E.GetFormattedTextStyles) do
	...
	ElvUF.Tags.Events[format("health:%s", tagTextFormat)] =
	...
	ElvUF.Tags.Events[format("power:%s", tagTextFormat)] =
		"UNIT_MAXENERGY UNIT_MAXFOCUS UNIT_MAXMANA UNIT_MAXRAGE UNIT_ENERGY UNIT_FOCUS UNIT_MANA UNIT_RAGE UNIT_MAXRUNIC_POWER UNIT_RUNIC_POWER"
	...
	ElvUF.Tags.Methods[format("mana:%s", tagTextFormat)] = function(unit)
		...
		if min == 0 and tagTextFormat ~= "deficit" then
			...
			return E:GetFormattedText(
				textFormat,
				UnitPower(unit, SPELL_POWER_MANA),
				UnitPowerMax(unit, SPELL_POWER_MANA)
			)
		end
	end
end
...
for textFormat, length in pairs({ veryshort = 5, short = 10, medium = 15, long = 20 }) do
	ElvUF.Tags.Events[format("health:deficit-percent:name-%s", textFormat)] =
		"UNIT_HEALTH UNIT_MAXHEALTH UNIT_CONNECTION PLAYER_FLAGS_CHANGED"
	...
	ElvUF.Tags.Events[format("name:%s:status", textFormat)] =
		"UNIT_NAME_UPDATE UNIT_CONNECTION PLAYER_FLAGS_CHANGED UNIT_HEALTH"
...
ElvUF.Tags.Events["specialization"] =
	"UNIT_NAME_UPDATE ACTIVE_TALENT_GROUP_CHANGED PLAYER_TALENT_UPDATE INSPECT_TALENT_READY UNIT_PORTRAIT_UPDATE"
...
E.TagInfo = {
	...
	["difficultycolor"] = {
		category = "Colors",
		description = "Colors the following tags by difficulty, red for impossible, orange for hard, green for easy",
	},
	["healthcolor"] = {
		category = "Colors",
		description = "Changes color of health text, depending on the unit's current health",
	},
	["threatcolor"] = {
		category = "Colors",
		description = "Changes color of health, depending on the unit's threat situation",
	},
	["classificationcolor"] = {
		category = "Colors",
		description = "Changes color of health, depending on the unit's classification",
	},
	--Classification
	["classification"] = {
	...
	["guild:brackets"] = {
		category = "Guild",
		description = "Displays the guild name with < > brackets (e.g. <GUILD>)",
	},
	["guild:brackets:translit"] = {
		category = "Guild",
		description = "Displays the guild name with < > and transliteration (e.g. <GUILD>)",
	},
	["guild:rank"] = { category = "Guild", description = "Displays the guild rank" },
	["guild:translit"] = {
		category = "Guild",
		description = "Displays the guild name with transliteration for cyrillic letters",
	},
	--Health
	...
	["deficit:name"] = {
		category = "Health",
		description = "Displays the health as a deficit and the name at full health",
	},
	["health:current"] = { category = "Health", description = "Displays the current health of the unit" },
	["health:current-max"] = {
		category = "Health",
		description = "Displays the current and maximum health of the unit, separated by a dash",
	},
	["health:current-max-nostatus"] = {
		category = "Health",
		description = "Displays the current and maximum health of the unit, separated by a dash, without status",
	},
	["health:current-max-percent"] = {
		category = "Health",
		description = "Displays the current and max hp of the unit, separated by a dash (% when not full hp)",
	},
	["health:current-max-percent-nostatus"] = {
		category = "Health",
		description = "Displays the current and max hp of the unit, separated by a dash (% when not full hp), without status",
	},
	["health:current-nostatus"] = {
		category = "Health",
		description = "Displays the current health of the unit, without status",
	},
	["health:current-percent"] = {
		category = "Health",
		description = "Displays the current hp of the unit (% when not full hp)",
	},
	["health:current-percent-nostatus"] = {
		category = "Health",
		description = "Displays the current hp of the unit (% when not full hp), without status",
	},
	["health:deficit"] = {
		category = "Health",
		description = "Displays the health of the unit as a deficit (Total Health - Current Health = -Deficit)",
	},
	["health:deficit-nostatus"] = {
		category = "Health",
		description = "Displays the health of the unit as a deficit, without status",
	},
	["health:deficit-percent:name"] = {
		category = "Health",
		description = "Displays the health deficit as a percentage and the full name of the unit",
	},
	["health:deficit-percent:name-long"] = {
		category = "Health",
		description = "Displays the health deficit as a percentage and the name of the unit (limited to 20 letters)",
	},
	["health:deficit-percent:name-medium"] = {
		category = "Health",
		description = "Displays the health deficit as a percentage and the name of the unit (limited to 15 letters)",
	},
	["health:deficit-percent:name-short"] = {
		category = "Health",
		description = "Displays the health deficit as a percentage and the name of the unit (limited to 10 letters)",
	},
	["health:deficit-percent:name-veryshort"] = {
		category = "Health",
		description = "Displays the health deficit as a percentage and the name of the unit (limited to 5 letters)",
	},
	["health:max"] = { category = "Health", description = "Displays the maximum health of the unit" },
	["health:percent"] = {
		category = "Health",
		description = "Displays the current health of the unit as a percentage",
	},
	["health:percent-nostatus"] = {
		category = "Health",
		description = "Displays the unit's current health as a percentage, without status",
	},
	["missinghp"] = {
		category = "Health",
	...
	["smartlevel"] = {
		category = "Level",
		description = "Only display the unit's level if it is not the same as yours",
	},
	...
	["mana:current-percent"] = {
		category = "Mana",
		description = "Displays the current amount of mana as a whole number and a percentage, separated by a dash",
	},
	["mana:current-max"] = {
		category = "Mana",
		description = "Displays the current mana and max mana, separated by a dash",
	},
	["mana:current-max-percent"] = {
		category = "Mana",
		description = "Displays the current mana and max mana, separated by a dash (% when not full power)",
	},
	...
	["mana:deficit"] = {
		category = "Mana",
		description = "Displays the mana deficit (Total Mana - Current Mana = -Deficit)",
	},
	...
	["name:veryshort:translit"] = {
		category = "Names",
		description = "Displays the name of the unit with transliteration for cyrillic letters (limited to 5 letters)",
	},
	["name:short:translit"] = {
		category = "Names",
		description = "Displays the name of the unit with transliteration for cyrillic letters (limited to 10 letters)",
	},
	["name:medium:translit"] = {
		category = "Names",
		description = "Displays the name of the unit with transliteration for cyrillic letters (limited to 15 letters)",
	},
	["name:long:translit"] = {
		category = "Names",
		description = "Displays the name of the unit with transliteration for cyrillic letters (limited to 20 letters)",
	},
	["name:abbrev"] = {
		category = "Names",
		description = "Displays the name of the unit with abbreviation (e.g. 'Shadowfury Witch Doctor' becomes 'S. W. Doctor')",
	},
	["name:abbrev:veryshort"] = {
		category = "Names",
		description = "Displays the name of the unit with abbreviation (limited to 5 letters)",
	},
	["name:abbrev:short"] = {
		category = "Names",
		description = "Displays the name of the unit with abbreviation (limited to 10 letters)",
	},
	["name:abbrev:medium"] = {
		category = "Names",
		description = "Displays the name of the unit with abbreviation (limited to 15 letters)",
	},
	["name:abbrev:long"] = {
		category = "Names",
		description = "Displays the name of the unit with abbreviation (limited to 20 letters)",
	},
	["name:veryshort:status"] = {
		category = "Names",
		description = "Replace the name of the unit with 'DEAD' or 'OFFLINE' if applicable (limited to 5 letters)",
	},
	["name:short:status"] = {
		category = "Names",
		description = "Replace the name of the unit with 'DEAD' or 'OFFLINE' if applicable (limited to 10 letters)",
	},
	["name:medium:status"] = {
		category = "Names",
		description = "Replace the name of the unit with 'DEAD' or 'OFFLINE' if applicable (limited to 15 letters)",
	},
	["name:long:status"] = {
		category = "Names",
		description = "Replace the name of the unit with 'DEAD' or 'OFFLINE' if applicable (limited to 20 letters)",
	},
	...
	["leaderlong"] = {
		...
		description = "Displays 'Leader' if the unit is the group/raid leader",
	},
	--Power
	["power:current"] = { category = "Power", description = "Displays the unit's current amount of power" },
	["power:current-percent"] = {
		category = "Power",
		description = "Displays the current power and power as a percentage, separated by a dash",
	},
	["power:current-max"] = {
		category = "Power",
		description = "Displays the current power and max power, separated by a dash",
	},
	["power:current-max-percent"] = {
		category = "Power",
		description = "Displays the current power and max power, separated by a dash (% when not full power)",
	},
	...
	["power:deficit"] = {
		category = "Power",
		description = "Displays the power as a deficit (Total Power - Current Power = -Deficit)",
	},
	...
	["realm:translit"] = {
		category = "Realm",
		description = "Displays the server name with transliteration for cyrillic letters",
	},
	["realm:dash"] = { category = "Realm", description = "Displays the server name with a dash in front (e.g. -Realm)" },
	["realm:dash:translit"] = {
		category = "Realm",
		description = "Displays the server name with transliteration for cyrillic letters and a dash in front",
	},
	--Status
	["status"] = { category = "Status", description = "Displays zzz, dead, ghost, offline" },
	["statustimer"] = {
		category = "Status",
		description = "Displays a timer for how long a unit has had the status (e.g 'DEAD - 0:34')",
	},
	...
	["target:veryshort"] = {
		category = "Target",
		description = "Displays the current target of the unit (limited to 5 letters)",
	},
	["target:short"] = {
		category = "Target",
		description = "Displays the current target of the unit (limited to 10 letters)",
	},
	["target:medium"] = {
		category = "Target",
		description = "Displays the current target of the unit (limited to 15 letters)",
	},
	["target:long"] = {
		category = "Target",
		description = "Displays the current target of the unit (limited to 20 letters)",
	},
	["target:translit"] = {
		category = "Target",
		description = "Displays the current target of the unit with transliteration for cyrillic letters",
	},
	["target:veryshort:translit"] = {
		category = "Target",
		description = "Displays the current target of the unit with transliteration for cyrillic letters (limited to 5 letters)",
	},
	["target:short:translit"] = {
		category = "Target",
		description = "Displays the current target of the unit with transliteration for cyrillic letters (limited to 10 letters)",
	},
	["target:medium:translit"] = {
		category = "Target",
		description = "Displays the current target of the unit with transliteration for cyrillic letters (limited to 15 letters)",
	},
	["target:long:translit"] = {
		category = "Target",
		description = "Displays the current target of the unit with transliteration for cyrillic letters (limited to 20 letters)",
	},
	--Threat
