...
local function CreateActionbarsConfig()
	...
	for i = 1, 6 do
		config.args["bar" .. i] = {
			...
			name = L["Bar "] .. i,
			get = function(info)
				return E.global.profileCopy.actionbar[info[#info]]
			end,
			set = function(info, value)
				E.global.profileCopy.actionbar[info[#info]] = value
			end,
		}
	end
	config.args.barPet = {
...
local function CreateAurasConfig()
	...
	config.args.buffs = {
		...
		name = L["Buffs"],
		get = function(info)
			return E.global.profileCopy.auras[info[#info]]
		end,
		set = function(info, value)
			E.global.profileCopy.auras[info[#info]] = value
		end,
	}
	config.args.debuffs = {
		order = 3,
...
local function CreateBagsConfig()
	...
	config.args.bagBar = {
		...
		name = L["Bag-Bar"],
		get = function(info)
			return E.global.profileCopy.bags[info[#info]]
		end,
		set = function(info, value)
			E.global.profileCopy.bags[info[#info]] = value
		end,
	}
	config.args.cooldown = {
		order = 3,
...
local function CreateCooldownConfig()
	...
	config.args.fonts = {
		...
		name = L["Fonts"],
		get = function(info)
			return E.global.profileCopy.cooldown[info[#info]]
		end,
		set = function(info, value)
			E.global.profileCopy.cooldown[info[#info]] = value
		end,
	}
...
local function CreateDatatbarsConfig()
	...
	config.args.experience = {
		...
		name = L["XPBAR_LABEL"],
		get = function(info)
			return E.global.profileCopy.databars[info[#info]]
		end,
		set = function(info, value)
			E.global.profileCopy.databars[info[#info]] = value
		end,
	}
...
local function CreateDatatextsConfig()
	...
	config.args.panels = {
		...
		name = L["Panels"],
		get = function(info)
			return E.global.profileCopy.datatexts[info[#info]]
		end,
		set = function(info, value)
			E.global.profileCopy.datatexts[info[#info]] = value
		end,
	}
...
local function CreateGeneralConfig()
	...
	config.args.minimap = {
		...
		get = function(info)
			return E.global.profileCopy.general[info[#info]]
		end,
		set = function(info, value)
			E.global.profileCopy.general[info[#info]] = value
		end,
	}
	config.args.threat = {
		order = 3,
...
local function CreateNamePlatesConfig()
	...
	config.args.cooldown = {
		...
		name = L["Cooldown Text"],
		get = function(info)
			return E.global.profileCopy.nameplates[info[#info]]
		end,
		set = function(info, value)
			E.global.profileCopy.nameplates[info[#info]] = value
		end,
	}
	...
	config.args.units = {
		...
		name = L["NamePlates"],
		get = function(info)
			return E.global.profileCopy.nameplates[info[#info - 1]][info[#info]]
		end,
		set = function(info, value)
			E.global.profileCopy.nameplates[info[#info - 1]][info[#info]] = value
		end,
		args = {
			["FRIENDLY_PLAYER"] = {
				order = 1,
...
local function CreateTooltipConfig()
	...
	config.args.visibility = {
		...
		name = L["Visibility"],
		get = function(info)
			return E.global.profileCopy.tooltip[info[#info]]
		end,
		set = function(info, value)
			E.global.profileCopy.tooltip[info[#info]] = value
		end,
	}
...
local function CreateUnitframesConfig()
	...
	config.args.cooldown = {
		...
		name = L["Cooldown Text"],
		get = function(info)
			return E.global.profileCopy.unitframe[info[#info]]
		end,
		set = function(info, value)
			E.global.profileCopy.unitframe[info[#info]] = value
		end,
	}
	config.args.colors = {
		order = 3,
		...
		name = L["COLORS"],
		get = function(info)
			return E.global.profileCopy.unitframe[info[#info - 1]][info[#info]]
		end,
		set = function(info, value)
			E.global.profileCopy.unitframe[info[#info - 1]][info[#info]] = value
		end,
		args = {
			["general"] = {
				order = 1,
		...
		modulecopy = {
			...
			args = {
				...
				profile = {
					...
					get = function(info)
						return E.global.profileCopy.selected
					end,
					set = function(info, value)
						E.global.profileCopy.selected = value
					end,
		...
		modulereset = {
			...
			args = {
				...
				general = {
					...
					func = function()
						E:CopyTable(E.db.general, P.general)
					end,
				},
				actionbar = {
					order = 5,
				...
				auras = {
					...
					func = function()
						E:CopyTable(E.db.auras, P.auras)
					end,
				},
				chat = {
					order = 8,
				...
				cooldown = {
					...
					func = function()
						E:CopyTable(E.db.cooldown, P.cooldown)
					end,
				},
				databars = {
					order = 10,
					...
					func = function()
						E:CopyTable(E.db.databars, P.databars)
					end,
				},
				datatexts = {
					order = 11,
					...
					func = function()
						E:CopyTable(E.db.datatexts, P.datatexts)
					end,
				},
				nameplates = {
					order = 12,
					...
					func = function()
						E:CopyTable(E.db.nameplates, P.nameplates)
					end,
				},
				tooltip = {
					order = 13,
					...
					func = function()
						E:CopyTable(E.db.tooltip, P.tooltip)
					end,
				},
				uniframes = {
					order = 14,
					...
					func = function()
						E:CopyTable(E.db.unitframe, P.unitframe)
						UF:Update_AllFrames()
					end,
				},
			},
