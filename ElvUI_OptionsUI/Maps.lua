...
E.Options.args.maps = {
	...
	args = {
		worldMap = {
			...
			args = {
				...
				enable = {
					...
					name = L["Enable"],
					get = function(info)
						return E.private.worldmap[info[#info]]
					end,
					set = function(info, value)
						E.private.worldmap[info[#info]] = value
				...
				generalGroup = {
					...
					args = {
						smallerWorldMap = {
							...
							get = function(info)
								return E.global.general.smallerWorldMap
							end,
							set = function(info, value)
						...
						fadeMapWhenMoving = {
							...
							get = function(info)
								return E.global.general.fadeMapWhenMoving
							end,
							set = function(info, value)
						...
						mapAlphaWhenMoving = {
							...
							step = 0.01,
							get = function(info)
								return E.global.general.mapAlphaWhenMoving
							end,
							set = function(info, value)
							...
							disabled = function()
								return not E.global.general.fadeMapWhenMoving
							end,
						},
					},
				},
				...
				coordinatesGroup = {
					...
					args = {
						enable = {
							...
							get = function(info)
								return E.global.general.WorldMapCoordinates.enable
							end,
							set = function(info, value)
						...
						position = {
							...
							name = L["Position"],
							get = function(info)
								return E.global.general.WorldMapCoordinates.position
							end,
							set = function(info, value)
							...
							disabled = function()
								return not E.global.general.WorldMapCoordinates.enable
							end,
							values = {
								["TOP"] = "TOP",
								["TOPLEFT"] = "TOPLEFT",
						...
						xOffset = {
							...
							name = L["X-Offset"],
							get = function(info)
								return E.global.general.WorldMapCoordinates.xOffset
							end,
							set = function(info, value)
						...
						yOffset = {
							...
							name = L["Y-Offset"],
							get = function(info)
								return E.global.general.WorldMapCoordinates.yOffset
							end,
							set = function(info, value)
		...
		minimap = {
			...
			get = function(info)
				return E.db.general.minimap[info[#info]]
			end,
			childGroups = "tab",
			args = {
				minimapHeader = {
				...
				generalGroup = {
					...
					args = {
						enable = {
							...
							get = function(info)
								return E.private.general.minimap[info[#info]]
							end,
							set = function(info, value)
				...
				locationTextGroup = {
					...
					args = {
						...
						locationText = {
							...
							get = function(info)
								return E.db.general.minimap.locationText
							end,
							set = function(info, value)
				...
				zoomResetGroup = {
					...
					args = {
						...
						enableZoomReset = {
							...
							name = L["Reset Zoom"],
							get = function(info)
								return E.db.general.minimap.resetZoom.enable
							end,
							set = function(info, value)
						...
						zoomResetTime = {
							...
							step = 1,
							get = function(info)
								return E.db.general.minimap.resetZoom.time
							end,
							set = function(info, value)
							...
							disabled = function()
								return (
									not E.db.general.minimap.resetZoom.enable or not E.private.general.minimap.enable
								)
							end,
						},
					},
				...
				icons = {
					...
					args = {
						...
						calendar = {
							...
							name = L["Calendar"],
							get = function(info)
								return E.db.general.minimap.icons.calendar[info[#info]]
							end,
							set = function(info, value)
							...
							args = {
								...
								hideCalendar = {
									...
									name = L["HIDE"],
									get = function(info)
										return E.private.general.minimap.hideCalendar
									end,
									set = function(info, value)
						...
						mail = {
							...
							name = L["MAIL_LABEL"],
							get = function(info)
								return E.db.general.minimap.icons.mail[info[#info]]
							end,
							set = function(info, value)
						...
						lfgEye = {
							...
							name = L["LFG Queue"],
							get = function(info)
								return E.db.general.minimap.icons.lfgEye[info[#info]]
							end,
							set = function(info, value)
						...
						battlefield = {
							...
							name = L["PvP Queue"],
							get = function(info)
								return E.db.general.minimap.icons.battlefield[info[#info]]
							end,
							set = function(info, value)
						...
						difficulty = {
							...
							get = function(info)
								return E.db.general.minimap.icons.difficulty[info[#info]]
							end,
							set = function(info, value)
						...
						vehicleLeave = {
							...
							get = function(info)
								return E.db.general.minimap.icons.vehicleLeave[info[#info]]
							end,
							set = function(info, value)
