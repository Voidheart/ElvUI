...
E.Options.args.skins = {
	...
	args = {
		...
		ace3 = {
			...
			set = function(info, value)
				E.private.skins.ace3.enable = value
				E:StaticPopup_Show("PRIVATE_RL")
			end,
		},
		checkBoxSkin = {
			...
			set = function(info, value)
				E.private.skins.checkBoxSkin = value
				E:StaticPopup_Show("PRIVATE_RL")
			end,
			disabled = function()
				return not E.private.skins.ace3.enable and not E.private.skins.blizzard.enable
			end,
		},
		dropdownCheckBoxSkin = {
			...
			get = function(info)
				return E.private.skins.dropdownCheckBoxSkin
			end,
			set = function(info, value)
				E.private.skins.dropdownCheckBoxSkin = value
				E:StaticPopup_Show("PRIVATE_RL")
			end,
			disabled = function()
				return not E.private.skins.ace3.enable and not E.private.skins.blizzard.enable
		...
		blizzard = {
			...
			name = "Blizzard",
			get = function(info)
				return E.private.skins.blizzard[info[#info]]
			end,
			set = function(info, value)
				E.private.skins.blizzard[info[#info]] = value
			...
			args = {
				...
				lootRoll = {
					...
					desc = L["TOGGLESKIN_DESC"],
					disabled = function()
						return E.private.general.lootRoll
					end,
				},
				macro = {
					type = "toggle",
