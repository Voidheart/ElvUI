...
E.Options.args.tooltip = {
	...
	args = {
		...
		enable = {
			...
			name = L["Enable"],
			get = function(info)
				return E.private.tooltip[info[#info]]
			end,
			set = function(info, value)
				E.private.tooltip[info[#info]] = value
		...
		general = {
			...
			name = L["General"],
			disabled = function()
				return not E.Tooltip.Initialized
			end,
			args = {
				header = {
					order = 1,
				...
				cursorAnchorType = {
					...
					disabled = function()
						return not E.db.tooltip.cursorAnchor
					end,
				},
				cursorAnchorX = {
					order = 4,
					...
					step = 1,
					disabled = function()
						return (not E.db.tooltip.cursorAnchor) or (E.db.tooltip.cursorAnchorType == "ANCHOR_CURSOR")
					end,
				},
				cursorAnchorY = {
					order = 5,
				...
				fontGroup = {
					...
					args = {
						...
						fontOutline = {
							...
							get = function(info)
								return E.db.tooltip.fontOutline
							end,
							set = function(info, value)
						...
						headerFontSize = {
							...
							step = 1,
							get = function(info)
								return E.db.tooltip.headerFontSize
							end,
							set = function(info, value)
						...
						textFontSize = {
							...
							step = 1,
							get = function(info)
								return E.db.tooltip.textFontSize
							end,
							set = function(info, value)
						...
						smallTextFontSize = {
							...
							step = 1,
							get = function(info)
								return E.db.tooltip.smallTextFontSize
							end,
							set = function(info, value)
				...
				factionColors = {
					...
					args = {
						useCustomFactionColors = {
							...
							name = L["Custom Faction Colors"],
							get = function(info)
								return E.db.tooltip.useCustomFactionColors
							end,
							set = function(info, value)
								E.db.tooltip.useCustomFactionColors = value
							end,
						},
					},
					get = function(info)
		...
		visibility = {
			...
			name = L["Visibility"],
			get = function(info)
				return E.db.tooltip.visibility[info[#info]]
			end,
			set = function(info, value)
				E.db.tooltip.visibility[info[#info]] = value
			end,
			disabled = function()
				return not E.Tooltip.Initialized
			end,
			args = {
				...
				combatOverride = {
					...
					disabled = function()
						return not E.db.tooltip.visibility.combat
					end,
					values = {
						["ALL"] = L["Always Hide"],
						["SHIFT"] = L["SHIFT_KEY"],
		...
		healthBar = {
			...
			name = L["Health Bar"],
			get = function(info)
				return E.db.tooltip.healthBar[info[#info]]
			end,
			set = function(info, value)
				E.db.tooltip.healthBar[info[#info]] = value
			end,
			disabled = function()
				return not E.Tooltip.Initialized
			end,
			args = {
				...
				height = {
					...
					step = 1,
					set = function(info, value)
						E.db.tooltip.healthBar.height = value
				...
				font = {
					...
					set = function(info, value)
						...
						GameTooltipStatusBar.text:FontTemplate(
							E.Libs.LSM:Fetch("font", E.db.tooltip.healthBar.font),
							E.db.tooltip.healthBar.fontSize,
							E.db.tooltip.healthBar.fontOutline
						)
					end,
					disabled = function()
						return not E.db.tooltip.healthBar.text
					end,
				},
				fontSize = {
					order = 6,
...
for i = 1, 8 do
	E.Options.args.tooltip.args.general.args.factionColors.args["" .. i] = {
		...
		disabled = function()
			return not E.Tooltip.Initialized or not E.db.tooltip.useCustomFactionColors
		end,
	}
end
