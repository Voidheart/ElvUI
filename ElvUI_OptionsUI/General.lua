...
E.Options.args.general = {
	...
	args = {
		...
		general = {
			...
			args = {
				...
				ignoreScalePopup = {
					...
					get = function(info)
						return E.global.general.ignoreScalePopup
					end,
					set = function(info, value)
						E.global.general.ignoreScalePopup = value
					end,
				},
				pixelPerfect = {
					order = 6,
				...
				eyefinity = {
					...
					get = function(info)
						return E.global.general.eyefinity
					end,
					set = function(info, value)
						E.global.general.eyefinity = value
				...
				locale = {
					...
					name = L["LANGUAGE"],
					get = function(info)
						return E.global.general.locale
					end,
					set = function(info, value)
				...
				fontGroup = {
					...
					args = {
						...
						dmgfont = {
							...
							values = AceGUIWidgetLSMlists.font,
							get = function(info)
								return E.private.general[info[#info]]
							end,
							set = function(info, value)
		...
		totems = {
			...
			name = L["Class Totems"],
			get = function(info)
				return E.db.general.totems[info[#info]]
			end,
			set = function(info, value)
				E.db.general.totems[info[#info]] = value
				Totems:PositionAndSize()
			end,
			hidden = function()
				return E.myclass ~= "SHAMAN"
			end,
			args = {
				header = {
					order = 1,
				...
				size = {
					...
					step = 1,
					disabled = function()
						return not E.db.general.totems.enable
					end,
				},
				spacing = {
					order = 4,
		...
		chatBubblesGroup = {
			...
			args = {
				...
				chatBubbleFont = {
					...
					values = AceGUIWidgetLSMlists.font,
					disabled = function()
						return E.private.general.chatBubbles == "disabled"
					end,
				},
				chatBubbleFontSize = {
					order = 4,
				...
				chatBubbleName = {
					...
					disabled = function()
						return E.private.general.chatBubbles == "disabled"
							or E.private.general.chatBubbles == "nobackdrop"
					end,
				},
			},
		},
		objectiveFrameGroup = {
			...
			args = {
				...
				watchFrameAutoHide = {
					...
					set = function(info, value)
						E.db.general.watchFrameAutoHide = value
						Blizzard:SetObjectiveFrameAutoHide()
					end,
				},
				watchFrameHeight = {
					order = 3,
					...
					step = 1,
					set = function(info, value)
						E.db.general.watchFrameHeight = value
		...
		threatGroup = {
			...
			name = L["Threat"],
			get = function(info)
				return E.db.general.threat[info[#info]]
			end,
			args = {
				threatHeader = {
					order = 1,
				...
				enable = {
					...
					name = L["Enable"],
					set = function(info, value)
						E.db.general.threat.enable = value
						Threat:ToggleEnable()
					end,
				},
				position = {
					...
					set = function(info, value)
						E.db.general.threat.position = value
						Threat:UpdatePosition()
					end,
					disabled = function()
						return not E.db.general.threat.enable
					end,
				},
				spacer = {
					order = 4,
				...
				textSize = {
					...
					step = 1,
					set = function(info, value)
						E.db.general.threat.textSize = value
						Threat:UpdatePosition()
					end,
					disabled = function()
						return not E.db.general.threat.enable
				...
				textOutline = {
					...
					values = C.Values.FontFlags,
					set = function(info, value)
						E.db.general.threat.textOutline = value
						Threat:UpdatePosition()
					end,
					disabled = function()
						return not E.db.general.threat.enable
		...
		misc = {
			...
			args = {
				...
				autoRoll = {
					...
					disabled = function()
						return not E.private.general.lootRoll
					end,
				},
			},
		},
