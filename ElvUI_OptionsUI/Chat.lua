				...
				historyGroup = {
					...
					args = {
						...
						resetHistory = {
							...
							disabled = function()
								return not E.db.chat.chatHistory
							end,
						},
						historySize = {
							order = 3,
						...
						historyTypes = {
							...
							get = function(info, key)
								return E.db.chat.showHistory[key]
							end,
				...
				tabSelection = {
					...
					args = {
						...
						tabSelectedTextColor = {
							...
							disabled = function()
								return not E.db.chat.tabSelectedTextEnabled
							end,
							get = function(info)
							...
							values = function()
								...
								for key, value in pairs(CH.TabStyles) do
									if key == "NONE" then
										...
										tabSelectorTable[key] =
											format(value, hexColor, format("%sName|r", selectedColor), hexColor)
									end
								end
						...
						tabSelectorColor = {
							...
							disabled = function()
								return E.db.chat.tabSelector == "NONE"
							end,
							get = function(info)
				...
				alerts = {
					...
					args = {
						...
						channelAlerts = {
							...
							guiInline = true,
							get = function(info)
								return E.db.chat.channelAlerts[info[#info]]
							end,
							set = function(info, value)
								E.db.chat.channelAlerts[info[#info]] = value
							end,
							args = {
								GUILD = {
									type = "select",
				...
				timestampGroup = {
					...
					args = {
						useCustomTimeColor = {
							...
							disabled = function()
								return not E.db.chat.timeStampFormat == "NONE"
							end,
						},
						customTimeColor = {
							order = 2,
							...
							disabled = function()
								return (not E.db.chat.timeStampFormat == "NONE" or not E.db.chat.useCustomTimeColor)
							end,
							get = function(info)
				...
				classColorMentionGroup = {
					...
					args = {
						classColorMentionsChat = {
							...
							get = function(info)
								return E.db.chat.classColorMentionsChat
							end,
							set = function(info, value)
								E.db.chat.classColorMentionsChat = value
							end,
							disabled = function()
						...
						classColorMentionsSpeech = {
							...
							desc = L["Use class color for the names of players when they are mentioned."],
							get = function(info)
								return E.private.general.classColorMentionsSpeech
							end,
							set = function(info, value)
								E.private.general.classColorMentionsSpeech = value
								E:StaticPopup_Show("PRIVATE_RL")
							end,
							disabled = function()
								return (E.private.general.chatBubbles == "disabled" or not E.private.chat.enable)
							end,
						},
						...
						classColorMentionExcludedNames = {
							...
							values = function()
								return E.global.chat.classColorMentionExcludedNames
							end,
							get = function(info, value)
								return E.global.chat.classColorMentionExcludedNames[value]
							end,
							set = function(info, value)
			...
			args = {
				...
				panelTabTransparency = {
					...
					set = function(info, value)
						...
						Layout:SetChatTabStyle()
					end,
					disabled = function()
						return not E.db.chat.panelTabBackdrop
					end,
				},
				editBoxPosition = {
					order = 4,
				...
				panelHeightRight = {
					...
					disabled = function()
						return not E.db.chat.separateSizes
					end,
					hidden = function()
						return not E.db.chat.separateSizes
					end,
