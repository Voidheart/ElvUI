...
L["Adjust the position of the threat bar to either the left or right datatext panels."] =
	"Ajustar a posição da barra de agro para os painéis de texto informativos da esquerda ou da direita."
...
L["Announce when you interrupt a spell to the specified chat channel."] =
	"Anunciar quando interromper um feitiço para o canal de bate-papo especificado."
...
L["Arena"] = true
L["Arrow Size"] = "Tamanho da Seta"
L["Arrow X-Offset"] = "Distância X da Seta"
L["Arrow Y-Offset"] = "Distância Y da Seta"
...
L["At what point should the text be displayed. Set to -1 to disable."] =
	"Em qual ponto o texto deve ser mostrado. Defina como -1 para desabilitar."
...
L["Attempt to lock the left and right chat frame positions. Disabling this option will allow you to move the main chat frame anywhere you wish."] =
	"Tentar bloquear a posição dos painéis do bate-papo esquerdo e direito. Desativar esta opção permitirá mover os painéis de bate-papo para qualquer lugar que desejar."
...
L["Automatically accept invites from guild/friends."] =
	"Aceitar convites de pessoas da lista de amigos ou guilda automaticamente"
...
L["Automatically repair using the following method when visiting a merchant."] =
	"Reparar automaticamente usando o seguinte método ao visitar um vendedor."
L["Automatically select greed or disenchant (when available) on green quality items. This will only work if you are the max level."] =
	"Selecionar automaticamente ganância ou desencantar (quando disponível) em itens de qualidade verde. Funciona apenas se estiver no nível máximo."
L["Automatically vendor gray items when visiting a vendor."] =
	"Vender itens cinzentos automaticamente quando visitar um vendedor"
...
L["Begin a new row or column after this many auras."] =
	"Começar uma nova coluna ou linha depois dessa quantia de auras."
...
L["Change settings for the display of the location text that is on the minimap."] =
	"Alterar as configurações de exibição do texto de localização que está no minimapa."
...
L["Color all buffs that reduce the unit's incoming damage."] =
	"Colorir todos os bônus que reduzem o dano recebido pela unidade."
...
L["Color of the actionbutton when out of power (Mana, Rage)."] =
	"Cor do botão de ação quando sem poder (Mana, Raiva)."
...
L["Color the unit healthbar if there is a debuff that can be dispelled by you."] =
	"Colorir a barra de vida se existir uma penalidade que você possa dissipar."
...
L["Create a filter, once created a filter can be set inside the buffs/debuffs section of each unit."] =
	"Criar um filtro, uma vez criado o filtro pode ser definido dentro da seção dos bônus/penalidades de cada unidade."
L["Credits"] = "Créditos"
L["Crop Icons"] = true
...
L["Delete a created filter, you cannot delete pre-existing filters, only custom ones."] =
	"Excluir um filtro criado, você não pode excluir filtros pré-existentes, apenas aqueles personalizados."
...
L["Direction the bag sorting will use to allocate the items."] =
	"Direção que o organizador de bolsas irá usar para distribuir os itens."
L["Direction the bar moves on gains/losses"] = true
L["Direction the health bar moves when gaining/losing health."] =
	"Direção em que a barra da vida se move quando se ganha/perde vida."
...
L["Display a healer icon over known healers inside battlegrounds or arenas."] =
	"Mostra um ícone de Curandeiro sobre curandeiros conhecidosem campos de batalha ou arenas."
L["Display a panel across the bottom of the screen. This is for cosmetic only."] =
	"Mostra um painel na parte inferior da tela. Apenas para efeito cosmético."
L["Display a panel across the top of the screen. This is for cosmetic only."] =
	"Mostra um painel na parte superior da tela. Apenas para efeito cosmético."
L["Display a spark texture at the end of the castbar statusbar to help show the differance between castbar and backdrop."] =
	"Exibir uma textura de faísca no fim da Barra de Lançamento para ajudar a diferenciar a barra de lançamento e o fundo."
...
L["Display cooldown text on anything with the cooldown spiral."] =
	"Exibir texto do tempo de recarga para tudo que tenha espiral de recarga."
L["Display data panels below the chat, used for datatexts."] =
	"Mostra painéis abaixo do bate-papo, usados para textos informativos."
...
L["Display minimap panels below the minimap, used for datatexts."] =
	"Exibir painéis abaixo do minimapa, usados para textos informativos."
...
L["Display the hyperlink tooltip while hovering over a hyperlink."] =
	"Exibir a tooltip de um hyperlink quando pairar por cima deste."
...
L["Display the spell or item ID when mousing over a spell or item tooltip."] =
	"Quando pairar o rato (mouse) sobre Itens ou Feitiços, mostra o ID destes na tooltip."
L["Display the target of your current cast. Useful for mouseover casts."] =
	"Mostra os alvos do seu lançamento atual. Útil para lançamentos mouseover."
L["Display tick marks on the castbar for channelled spells. This will adjust automatically for spells like Drain Soul and add additional ticks based on haste."] =
	"Exibir marcas na barra de lançamento para feitiços canalizados. Isto irá se ajustar automaticamente para feitiços como Drenar Alma e adicionará ticks baseado na Aceleração."
...
L["Force the frames to show, they will act as if they are the player frame."] =
	"Forçar os quadros para aparecerem, irão se comportar como se fossem o quadro do jogador."
...
L["Hides the red error text at the top of the screen while in combat."] =
	"Esconde o texto de erro vermelho do topo da tela quando em combate."
L["History Size"] = true
L["History"] = true
...
L["If enabled then the filter will only activate when you are resting at an Inn."] =
	"Se habilitado então o filtro irá apenas ser ativado quando você estiver descansado em uma estalagem."
...
L["If not set to 0 then override the size of the aura icon to this."] =
	"Se não definido 0 então sobrescreve o tamanho da aura para este."
...
L["Indicate whether buffs you cast yourself should be separated before or after."] =
	"Indica se os buffs que lança em si próprio devem ser separados antes ou depois."
...
L["List of words to color in chat if found in a message. If you wish to add multiple words you must seperate the word with a comma. To search for your current name you can use %MYNAME%.\n\nExample:\n%MYNAME%, ElvUI, RBGs, Tank"] =
	"Lista de palavras a colorir se encontrada numa mensagem. Se desejar adicionar multiplas palavras deverá separa-las com uma vírgula. Para procurar pelo seu nome actual pode usar %MYNAME%.\n\nExemplo:\n%MYNAME%, ElvUI, RBGs, Tank"
...
L["Log the main chat frames history. So when you reloadui or log in and out you see the history from your last session."] =
	"Armazenar o histórico dos quadros principais do bate-papo. Para que possa ver o histórico de sua última sessão ao relogar ou conectar e desconectar."
...
L["Middle clicking the unit frame will cause your focus to match the unit."] =
	"Clicar com o botão do meio no quadro da unidade fará o foco ser defenido para esta unidade."
L["Middle"] = true
L["Min Alpha"] = true
...
L["Multiply the backdrops height or width by this value. This is usefull if you wish to have more than one bar behind a backdrop."] =
	"Multiplicar a altura ou comprimento do fundo por este valor. Muito útil se desejar ter mais que uma barra por trás de um fundo."
...
L["Number of time in seconds to scroll down to the bottom of the chat window if you are not scrolled down completely."] =
	"Tempo, em segundos, para rolar o bate-papo até ao fim caso nao tenha rolado completamente."
L["Objective Frame Height"] = true
L["Off Cooldown"] = true
L["Offset of the powerbar to the healthbar, set to 0 to disable."] =
	"A distância entre barra de poder e a barra de vida, definir 0 para desactivar."
...
L["Override any custom visibility setting in certain situations, EX: Only show groups 1 and 2 inside a 10 man instance."] =
	"Sobrescrever qualquer visibilidade personalizada em certas situações, Ex: Mostrar apenas grupo 1 e 2 dentro de uma instância de 10 pessoas."
...
L["Position of the Chat EditBox, if datatexts are disabled this will be forced to be above chat."] =
	"A posição da caixa de edição do bate-papo, será forçada para cima do bate-papo se os textos informativos estiverem desativados."
L["Position"] = "Posição"
...
L["Power text will be hidden on NPC targets, in addition the name text will be repositioned to the power texts anchor point."] =
	"Em PNJs o texto de poder não será mostrado, em adição o texto de nome será reposicionado para o ponto de fixação do texto de poder."
L["Power"] = "Poder"
L["Powers"] = "Poderes"
L["Prevent the same messages from displaying in chat more than once within this set amount of seconds, set to zero to disable."] =
	"Prevenir que as mesmas mensagens sejam exibidas no bate-papo mais que uma vez dentro desta quantidade de segundos, definir 0 para desativar."
...
L["Rapidly update the health, uses more memory and cpu. Only recommended for healing."] =
	"Atualizar rapidamente a vida, usa mais memória e CPU. Apenas recomendado para curandeiros."
...
L["Send ADDON_ACTION_BLOCKED errors to the Lua Error frame. These errors are less important in most cases and will not effect your game performance. Also a lot of these errors cannot be fixed. Please only report these errors if you notice a Defect in gameplay."] =
	"Mandar os erros de AÇÃO do ADDON BLOQUEADA para o quadro de erros de Lua. Estes erros são, na maioria das vezes, pouco importantes e não irão afetar o seu desempenho de jogo. Muitos destes erros nao podem ser reparados. Por favor denuncie estes erros apenas se notar problemas no desempenho do jogo."
...
L["Set the font size for everything in UI. Note: This doesn't effect somethings that have their own seperate options (UnitFrame Font, Datatext Font, ect..)"] =
	"Define o tamanho da fonte para toda a Interface. Nota: Isto nao afeta coisas que tenham suas prórpias opções de fonte (Quadros de Unidade, Textos Informativos, etc..)"
...
L["Set the priority order of the spell, please note that prioritys are only used for the raid debuff module, not the standard buff/debuff module. If you want to disable set to zero."] =
	"Define a ordem prioritária dos feitiços, por favor note que prioridades só são usadas o modo de Penalidades de Raide, não para o modo normal de bônus/penalidades."
...
L["Set the type of auras to show when a unit is a foe."] =
	"Define o tipo de auras a serem mostradas quando a unidade é um inimigo."
L["Set the type of auras to show when a unit is friendly."] =
	"Define o tipo de auras a serem mostradas quando a unidade é aliada."
...
L["Sets the font instance's horizontal text alignment style."] =
	"Define o estilo de alinhamento horizontal da instância da fonte."
...
L["Show an incoming heal prediction bar on the unitframe. Also display a slightly different colored bar for incoming overheals."] =
	"Mostra a barra de predicção de cura no quadro de unidade. Também exibe uma barra com uma cor ligeiramente diferente para a predicção de sobrecura."
...
L["The button you must hold down in order to drag an ability to another action button."] =
	"Botão que deve ser pressionado para permitir o arrastar uma habilidade para outro botão de acção"
...
L["The direction that the bag frames be (Horizontal or Vertical)."] =
	"Direcção em que os quadros das bolsas são (Horizontal ou Vertical)."
L["The direction that the bag frames will grow from the anchor."] =
	"Direcção para qual as barras crescerão a partir do seu Fixador."
...
L["The display format of the currency icons that get displayed below the main bag. (You have to be watching a currency for this to display)"] =
	"O formato de exibição dos ícones de moeda exibidos abaixo da bolsa principal. (Para isto ser exibido é necessário que selecione Mostrar na Mochila na moeda desejada na aba Moeda dentro do Quadro do Personagem)."
...
L["The following macro must be true in order for the group to be shown, in addition to any filter that may already be set."] =
	"A macro seguinte tem de ser verdadeira para que o grupo seja mostrado, em adição a qualquer outro filtro que possa já estar definido."
L["The font that appears on the text above players heads. |cffFF0000WARNING: This requires a game restart or re-log for this change to take effect.|r"] =
	"A fonte do texto que aparece sobre a cabeça dos jogadores. |cffFF0000ATENÇÃO: Para esta alteração fazer efeito é necessário que o jogo seja reiniciado ou relogado.|r"
L["The font that combat text will use. |cffFF0000WARNING: This requires a game restart or re-log for this change to take effect.|r"] =
	"Fonte que o texto de combate usará. |cffFF0000AVISO: Para que as mudanças sejam efetuadas é necessário reiniciar ou relogar o jogo."
...
L["The frame is not shown unless you mouse over the frame."] =
	"A não ser que passe com o rato (mouse) por cima do quadro, este não será mostrado."
L["The initial group will start near the center and grow out."] =
	"O grupo inicial começara perto do centro e crescerá para fora."
...
L["The name you have selected is already in use by another element."] =
	"O nome que escolheu já está a ser usado noutro elemento."
...
L["The size of the individual buttons on the bag frame."] =
	"O tamanho individual de botões dentro do quadro das bolsas."
L["The size of the individual buttons on the bank frame."] =
	"O tamanho individual de botões dentro do quadro do banco."
...
L["The texture that will be used mainly for statusbars."] =
	"Textura que será usada principalmente para a barras de estado."
...
L["This feature will allow you to transfer settings to other characters."] =
	"Este recurso permite enviar sus configurações a outros personagens."
...
L["This texture will get used on objects like chat windows and dropdown menus."] =
	"Esta textura será usada em objetos como janelas de bate-papo e menus de suspensão."
...
L["Threshold before text turns red and is in decimal form. Set to -1 for it to never turn red"] =
	"Limiar antes do texto se tornar vermelho e em forma décimal. Definir -1 para nunca se tornar vermelho"
...
L["Toggle showing of the left and right chat panels."] =
	"Mostrar/Ocultar os painéis de conversação da esquerda e direita."
...
L["Unlock various elements of the UI to be repositioned."] =
	"Destravar vários elementos da interface para serem reposicionados."
L["Up"] = "Acima"
L["Usable"] = true
L["Use Alt Key"] = true
...
L["Use the custom backdrop color instead of a multiple of the main color."] =
	"Usar a cor de fundo da vida personalizada em vez de um multiplo da cor de vida principal."
...
L["What point to anchor to the frame you set to attach to."] =
	"Qual é o ponto a fixar ao quadro que você definiu para ser anexado."
...
L["When in a raid group display if anyone in your raid is targeting the current tooltip unit."] =
	"Exibe se alguém em sua raide tem como alvo a unidade da tooltip."
L["When inside a battleground display personal scoreboard information on the main datatext bars."] =
	"Exibir informação do placar pessoal nos textos informativos principais quando dentro de um Campo de Batalha"
L["When opening the Chat Editbox to type a message having this option set means it will retain the last channel you spoke in. If this option is turned off opening the Chat Editbox should always default to the SAY channel."] =
	"Ter esta opção ativada significa que sempre que escrever algo será usado o último canal no qual escreveu. Se a opção estiver desativada escreverá sempre no canal padrão DIZER"
L["When true, the header includes the player when not in a raid."] =
	"Quando verdade, o cabeçalho inclui o jogador quando não está em Raide."
...
L["You may not remove a spell from a default filter that is not customly added. Setting spell to false instead."] =
	"Você não pode remover um feitiço de um filtro padrão que não seja um feitiço personalizado. Em vez disso definindo feitiço para falso."
...
L[ [=[This works like a macro, you can run different situations to get the actionbar to page differently.
 Example: '[combat] 2;']=] ] =
	[=[Isto funciona como uma macro, você pode executar várias situações para que a barra de ação pagine de forma diferente.
 Exemplo: '[combat] 2;']=]

L[ [=[This works like a macro, you can run different situations to get the actionbar to show/hide differently.
 Example: '[combat] show;hide']=] ] =
	[=[Isto funciona como uma macro, você pode executar várias situações para mostrar/ocultar a barra de ação de forma diferente.
...
Or for most users it would be easier to simply put a tga file into your WoW folder, then type the name of the file here.]=] ] =
	[=[Especificar o nome de um ficheiro (arquivo) localizado na diretório do WoW. Ficheiros de textura que deseje ter como fundo dos painéis.
...
L["OPTION_TOOLTIP_ACTION_BUTTON_USE_KEY_DOWN"] =
	"As ações dos botões serão executadas quando a tecla for pressionada, em vez de quando for solta."
