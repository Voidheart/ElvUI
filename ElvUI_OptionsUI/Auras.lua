...
E.Options.args.auras = {
	...
	args = {
		...
		enable = {
			...
			name = L["Enable"],
			get = function(info)
				return E.private.auras[info[#info]]
			end,
			set = function(info, value)
		...
		general = {
			...
			args = {
				...
				statusBar = {
					...
					args = {
						...
						barColor = {
							...
							hasAlpha = false,
							disabled = function()
								return not E.db.auras.barShow or (E.db.auras.barColorGradient or not E.db.auras.barShow)
							end,
							get = function(info)
				...
				lbf = {
					...
					name = L["LBF Support"],
					get = function(info)
						return E.private.auras.lbf[info[#info]]
					end,
					set = function(info, value)
						E.private.auras.lbf[info[#info]] = value
						E:StaticPopup_Show("PRIVATE_RL")
					end,
					disabled = function()
						return not E.private.auras.enable
					end,
					args = {
						enable = {
							order = 1,
		...
		buffs = {
			...
			name = L["Buffs"],
			get = function(info)
				return E.db.auras.buffs[info[#info]]
			end,
			set = function(info, value)
				E.db.auras.buffs[info[#info]] = value
				A:UpdateHeader(ElvUIPlayerBuffs)
			end,
		...
		debuffs = {
			...
			name = L["Debuffs"],
			get = function(info)
				return E.db.auras.debuffs[info[#info]]
			end,
			set = function(info, value)
				E.db.auras.debuffs[info[#info]] = value
				A:UpdateHeader(ElvUIPlayerDebuffs)
			end,
		...
		reminder = {
			...
			name = L["Reminder"],
			get = function(info)
				return E.db.general.reminder[info[#info]]
			end,
			set = function(info, value)
				E.db.general.reminder[info[#info]] = value
				RB:UpdateSettings()
			end,
			disabled = function()
			...
			args = {
				...
				generalGroup = {
					...
					name = L["General"],
					disabled = function()
						return not E.db.general.reminder.enable
					end,
					args = {
						durations = {
							order = 1,
				...
				fontGroup = {
					...
					name = L["Font"],
					disabled = function()
						return not E.db.general.reminder.enable or not E.db.general.reminder.durations
					end,
					args = {
						font = {
							order = 1,
