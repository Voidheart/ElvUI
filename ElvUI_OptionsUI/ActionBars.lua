...
local function BuildABConfig()
	group.general = {
		...
		childGroups = "tab",
		disabled = function()
			return not E.ActionBars.Initialized
		end,
		args = {
			info = {
				order = 1,
			...
			movementModifier = {
				...
				disabled = function()
					return (not E.private.actionbar.enable or not E.db.actionbar.lockActionBars)
				end,
				values = {
					["NONE"] = L["NONE"],
					["SHIFT"] = L["SHIFT_KEY"],
			...
			equippedItem = {
				...
				get = function(info)
					return E.db.actionbar[info[#info]]
				end,
				set = function(info, value)
					E.db.actionbar[info[#info]] = value
					AB:UpdateButtonSettings()
			...
			equippedItemColor = {
				...
				disabled = function()
					return not E.db.actionbar.equippedItem
				end,
			},
			colorGroup = {
				order = 17,
			...
			lbf = {
				...
				name = L["LBF Support"],
				get = function(info)
					return E.private.actionbar.lbf[info[#info]]
				end,
				set = function(info, value)
	...
	if E.myclass == "SHAMAN" then
		group.barTotem = {
			...
			guiInline = false,
			disabled = function()
				return not E.ActionBars.Initialized or not E.myclass == "SHAMAN"
			end,
			get = function(info)
				return E.db.actionbar.barTotem[info[#info]]
			end,
			set = function(info, value)
			...
			args = {
				...
				restorePosition = {
					...
					disabled = function()
						return not E.db.actionbar.barTotem.enabled
					end,
				},
				spacer = {
					order = 4,
	...
	group.barPet = {
		...
		get = function(info)
			return E.db.actionbar.barPet[info[#info]]
		end,
		set = function(info, value)
		...
		args = {
			...
			restorePosition = {
				...
				disabled = function()
					return not E.db.actionbar.barPet.enabled
				end,
			},
			spacer = {
				order = 4,
	...
	group.stanceBar = {
		...
		get = function(info)
			return E.db.actionbar.stanceBar[info[#info]]
		end,
		set = function(info, value)
		...
		args = {
			...
			restorePosition = {
				...
				disabled = function()
					return not E.db.actionbar.stanceBar.enabled
				end,
			},
			spacer = {
				order = 4,
	...
	group.microbar = {
		...
		get = function(info)
			return E.db.actionbar.microbar[info[#info]]
		end,
		set = function(info, value)
		...
		args = {
			...
			restoreMicrobar = {
				...
				disabled = function()
					return not E.db.actionbar.microbar.enabled
				end,
			},
			spacer = {
				order = 4,
	...
	for i = 1, 6 do
		...
		group["bar" .. i] = {
			...
			get = function(info)
				return E.db.actionbar["bar" .. i][info[#info]]
			end,
			set = function(info, value)
			...
			args = {
				...
				restorePosition = {
					...
					disabled = function()
						return not E.db.actionbar["bar" .. i].enabled
					end,
				},
				spacer = {
					order = 4,
				...
				paging = {
					...
					multiline = true,
					get = function(info)
						return E.db.actionbar["bar" .. i].paging[E.myclass]
					end,
					set = function(info, value)
						if value and value:match("[\n\r]") then
							value = value:gsub("[\n\r]", "")
...
E.Options.args.actionbar = {
	...
	args = {
		enable = {
			...
			name = L["Enable"],
			get = function(info)
				return E.private.actionbar[info[#info]]
			end,
			set = function(info, value)
		...
		generalShortcut = {
			...
			name = L["General"],
			func = function()
				ACD:SelectGroup("ElvUI", "actionbar", "general")
			end,
			disabled = function()
				return not E.ActionBars.Initialized
			end,
		...
		cooldownTextShortcut = {
			...
			name = L["Cooldowns"],
			func = function()
				ACD:SelectGroup("ElvUI", "cooldown", "actionbar")
			end,
		},
		petBarShortcut = {
			order = 7,
			...
			name = L["Pet Bar"],
			func = function()
				ACD:SelectGroup("ElvUI", "actionbar", "barPet")
			end,
			disabled = function()
				return not E.ActionBars.Initialized
			end,
		...
		totemBarShortcut = {
			...
			name = L["TUTORIAL_TITLE47"],
			func = function()
				ACD:SelectGroup("ElvUI", "actionbar", "barTotem")
			end,
			disabled = function()
				return not E.ActionBars.Initialized
			end,
		...
		bar2Shortcut = {
			...
			name = L["Bar "] .. 2,
			func = function()
				ACD:SelectGroup("ElvUI", "actionbar", "bar2")
			end,
			disabled = function()
				return not E.ActionBars.Initialized
			end,
		...
		bar3Shortcut = {
			...
			name = L["Bar "] .. 3,
			func = function()
				ACD:SelectGroup("ElvUI", "actionbar", "bar3")
			end,
			disabled = function()
				return not E.ActionBars.Initialized
			end,
		...
		bar4Shortcut = {
			...
			name = L["Bar "] .. 4,
			func = function()
				ACD:SelectGroup("ElvUI", "actionbar", "bar4")
			end,
			disabled = function()
				return not E.ActionBars.Initialized
			end,
		...
		bar5Shortcut = {
			...
			name = L["Bar "] .. 5,
			func = function()
				ACD:SelectGroup("ElvUI", "actionbar", "bar5")
			end,
			disabled = function()
				return not E.ActionBars.Initialized
			end,
		...
		bar6Shortcut = {
			...
			name = L["Bar "] .. 6,
			func = function()
				ACD:SelectGroup("ElvUI", "actionbar", "bar6")
			end,
			disabled = function()
				return not E.ActionBars.Initialized
			end,
