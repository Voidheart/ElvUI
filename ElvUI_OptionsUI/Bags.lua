...
E.Options.args.bags = {
	...
	args = {
				...
				countGroup = {
					...
					args = {
						...
						countFontOutline = {
							...
							name = L["Font Outline"],
							set = function(info, value)
								E.db.bags.countFontOutline = value
								B:UpdateCountDisplay()
							end,
				...
				itemLevelGroup = {
					...
					args = {
						...
						itemLevelCustomColorEnable = {
							...
							disabled = function()
								return not E.db.bags.itemLevel
							end,
							set = function(info, value)
								E.db.bags.itemLevelCustomColorEnable = value
								B:UpdateItemLevelDisplay()
							end,
						},
						itemLevelCustomColor = {
							...
							name = L["Custom Color"],
							disabled = function()
								return not E.db.bags.itemLevel or not E.db.bags.itemLevelCustomColorEnable
							end,
							get = function(info)
						...
						itemLevelThreshold = {
							...
							set = function(info, value)
								E.db.bags.itemLevelThreshold = value
								B:UpdateItemLevelDisplay()
							end,
						},
						itemLevelFont = {
						...
						itemLevelFontSize = {
							...
							set = function(info, value)
								E.db.bags.itemLevelFontSize = value
								B:UpdateItemLevelDisplay()
							end,
						},
						itemLevelFontOutline = {
							...
							set = function(info, value)
								E.db.bags.itemLevelFontOutline = value
								B:UpdateItemLevelDisplay()
							end,
							values = C.Values.FontFlags,
						},
			...
			args = {
				...
				profession = {
					...
					set = function(info, r, g, b)
						local t = E.db.bags.colors.profession[info[#info]]
						t.r, t.g, t.b = r, g, b
						if not E.Bags.Initialized then
							return
						end
					...
					args = {
						...
						quiver = {
							...
							name = L["Quiver"],
							disabled = function()
								return not E.db.bags.professionBagColors
							end,
						},
						ammoPouch = {
							order = 4,
				...
				items = {
					...
					args = {
						...
						questStarter = {
							...
							disabled = function()
								return not E.db.bags.questItemColors
							end,
						},
						questItem = {
							order = 3,
		...
		bagBar = {
			...
			name = L["Bag-Bar"],
			get = function(info)
				return E.db.bags.bagBar[info[#info]]
			end,
			set = function(info, value)
				E.db.bags.bagBar[info[#info]] = value
			...
			args = {
				...
				enable = {
					...
					get = function(info)
						return E.private.bags.bagBar
					end,
					set = function(info, value)
						E.private.bags.bagBar = value
						E:StaticPopup_Show("PRIVATE_RL")
					end,
				},
				showBackdrop = {
					...
					name = L["Backdrop"],
					disabled = function()
						return not E.private.bags.bagBar
					end,
				},
				mouseover = {
					order = 4,
		...
		split = {
			...
			name = L["Split"],
			get = function(info)
				return E.db.bags.split[info[#info]]
			end,
			set = function(info, value)
				E.db.bags.split[info[#info]] = value
				B:UpdateAll()
			end,
			disabled = function()
				return not E.Bags.Initialized
			...
			args = {
				...
				splitbags = {
					...
					disabled = function()
						return not E.db.bags.split.player
					end,
					guiInline = true,
					args = {
						bag1 = {
				...
				splitbank = {
					...
					disabled = function()
						return not E.db.bags.split.bank
					end,
					guiInline = true,
					args = {
						bag5 = {
		...
		vendorGrays = {
			...
			name = L["Vendor Grays"],
			get = function(info)
				return E.db.bags.vendorGrays[info[#info]]
			end,
			set = function(info, value)
				E.db.bags.vendorGrays[info[#info]] = value
				B:UpdateSellFrameSettings()
			end,
			args = {
				header = {
					order = 1,
				...
				interval = {
					...
					step = 0.1,
					disabled = function()
						return not E.db.bags.vendorGrays.enable
					end,
				},
				details = {
					order = 4,
		...
		bagSortingGroup = {
			...
			args = {
				...
				addEntryGroup = {
					...
					args = {
						addEntryProfile = {
							...
							set = function(info, value)
								if value == "" or gsub(value, "%s+", "") == "" then
									return
								end --Don't allow empty entries
				...
				ignoredEntriesProfile = {
					...
					values = function()
						return E.db.bags.ignoredItems
					end,
					get = function(info, value)
						return E.db.bags.ignoredItems[value]
					end,
					set = function(info, value)
				...
				ignoredEntriesGlobal = {
					...
					values = function()
						return E.global.bags.ignoredItems
					end,
					get = function(info, value)
						return E.global.bags.ignoredItems[value]
					end,
					set = function(info, value)
