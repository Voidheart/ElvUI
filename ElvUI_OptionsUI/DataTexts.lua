	...
	for pointLoc, tab in pairs(P.datatexts.panels) do
		...
		if type(tab) == "table" then
			...
			for option in pairs(tab) do
				table[pointLoc].args[option] = {
					...
					values = datatexts,
					get = function(info)
						return E.db.datatexts.panels[pointLoc][info[#info]]
					end,
		...
		elseif type(tab) == "string" then
			table.smallPanels.args[pointLoc] = {
				...
				values = datatexts,
				get = function(info)
					return E.db.datatexts.panels[pointLoc]
				end,
				set = function(info, value)
...
E.Options.args.datatexts = {
	...
	childGroups = "tab",
	get = function(info)
		return E.db.datatexts[info[#info]]
	end,
	set = function(info, value)
				...
				hideGroup = {
					...
					args = {
						hideAFK = {
							...
							name = L["AFK"],
							get = function(info)
								return E.db.datatexts.friends.hideAFK
							end,
							set = function(info, value)
								E.db.datatexts.friends.hideAFK = value
								DT:LoadDataTexts()
							end,
						},
						hideDND = {
							...
							name = L["DND"],
							get = function(info)
								return E.db.datatexts.friends.hideDND
							end,
							set = function(info, value)
								E.db.datatexts.friends.hideDND = value
								DT:LoadDataTexts()
							end,
						},
					},
