...
local function removePriority(value)
	...
	for n, t in pairs(x) do
		if t and t.buffs and t.buffs.priority and t.buffs.priority ~= "" then
			...
			if z then
				E.db.unitframe.units[n].buffs.priority = gsub(t.buffs.priority, z, "")
			end
		end
		if t and t.debuffs and t.debuffs.priority and t.debuffs.priority ~= "" then
			...
			if z then
				E.db.unitframe.units[n].debuffs.priority = gsub(t.debuffs.priority, z, "")
			end
		end
		if t and t.aurabar and t.aurabar.priority and t.aurabar.priority ~= "" then
			...
			if z then
				E.db.unitframe.units[n].aurabar.priority = gsub(t.aurabar.priority, z, "")
			end
		end
	end
	for n, t in pairs(y) do
		if t and t.buffs and t.buffs.priority and t.buffs.priority ~= "" then
			z = filterMatch(t.buffs.priority, E:EscapeString(value))
			if z then
				E.db.nameplates.units[n].buffs.priority = gsub(t.buffs.priority, z, "")
			end
		end
		if t and t.debuffs and t.debuffs.priority and t.debuffs.priority ~= "" then
			z = filterMatch(t.debuffs.priority, E:EscapeString(value))
			if z then
				E.db.nameplates.units[n].debuffs.priority = gsub(t.debuffs.priority, z, "")
			end
		end
	end
end
			...
			args = {
				addSpell = {
					...
					set = function(info, value)
						...
						E.global.unitframe.DebuffHighlightColors[value] =
							{ enable = true, style = "GLOW", color = { r = 0.8, g = 0, b = 0, a = 0.85 } }
						UpdateFilterGroup()
						UF:Update_AllFrames()
					end,
				},
				removeSpell = {
					...
					disabled = function()
						return not (selectedSpell and selectedSpell ~= "")
					end,
				},
				quickSearch = {
					order = 3,
				...
				selectSpell = {
					...
					values = function()
						...
						for filter in pairs(list) do
							...
							if filter:lower():find(searchText) then
		...
		E.Options.args.filters.args.resetGroup = {
			...
			args = {
				enableReset = {
					...
					name = L["Enable"],
					get = function(info)
						return FilterResetState[selectedFilter]
					end,
					set = function(info, value)
				...
				resetFilter = {
					...
					disabled = function()
						return not FilterResetState[selectedFilter]
					end,
					func = function(info)
				...
				addSpellID = {
					...
					set = function(info, value)
						...
						elseif not GetSpellInfo(value) then
							...
							E.global.unitframe.buffwatch.PET[tonumber(value)] = {
								["enabled"] = true,
								["id"] = tonumber(value),
								["point"] = "TOPRIGHT",
								["color"] = { ["r"] = 1, ["g"] = 0, ["b"] = 0 },
					...
					values = function()
						...
						for _, spell in pairs(list) do
							if spell.id then
								...
								if name and name:lower():find(searchText) then
		...
		if selectedSpell then
			...
			if name then
				E.Options.args.filters.args.filterGroup.args[name] = {
					...
					get = function(info)
						return E.global.unitframe.buffwatch.PET[selectedSpell][info[#info]]
					end,
					set = function(info, value)
						E.global.unitframe.buffwatch.PET[selectedSpell][info[#info]] = value
						UF:CreateAndUpdateUF("pet")
					end,
					args = {
						enabled = {
	...
	elseif selectedFilter == "Buff Indicator" then
				...
				addSpellID = {
					...
					set = function(info, value)
						...
						elseif not GetSpellInfo(value) then
							...
							E.global.unitframe.buffwatch[E.myclass][tonumber(value)] = {
								["enabled"] = true,
								["id"] = tonumber(value),
								["point"] = "TOPRIGHT",
								["color"] = { ["r"] = 1, ["g"] = 0, ["b"] = 0 },
		...
		if selectedSpell then
			...
			E.Options.args.filters.args.filterGroup.args[name] = {
				...
				name = name .. " (" .. selectedSpell .. ")",
				get = function(info)
					return E.global.unitframe.buffwatch[E.myclass][selectedSpell][info[#info]]
				end,
				set = function(info, value)
				...
				args = {
					...
					textColor = {
						...
						set = function(info, r, g, b)
							E.global.unitframe.buffwatch[E.myclass][selectedSpell].textColor = E.global.unitframe.buffwatch[E.myclass][selectedSpell].textColor
								or {}
	...
	elseif selectedFilter == "Buff Indicator (Profile)" then
				...
				addSpellID = {
					...
					set = function(info, value)
						...
						elseif not GetSpellInfo(value) then
							...
							E.db.unitframe.filters.buffwatch[tonumber(value)] = {
								["enabled"] = true,
								["id"] = tonumber(value),
								["point"] = "TOPRIGHT",
								["color"] = { ["r"] = 1, ["g"] = 0, ["b"] = 0 },
		...
		if selectedSpell then
			...
			E.Options.args.filters.args.filterGroup.args[name] = {
				...
				name = name .. " (" .. selectedSpell .. ")",
				hidden = function()
					return not E.db.unitframe.filters.buffwatch[selectedSpell]
				end,
				get = function(info)
		...
		E.Options.args.filters.args.filterGroup = {
			...
			args = {
				...
				filterType = {
					...
					get = function()
						return E.global.unitframe.aurafilters[selectedFilter].type
					end,
					set = function(info, value)
						E.global.unitframe.aurafilters[selectedFilter].type = value
						UF:Update_AllFrames()
					end,
				},
				quickSearch = {
			...
			E.Options.args.filters.args.resetGroup = {
				...
				args = {
					...
					resetFilter = {
						...
						func = function()
							E.global.unitframe.aurafilters[selectedFilter].spells =
								E:CopyTable({}, G.unitframe.aurafilters[selectedFilter].spells)
							selectedSpell = nil
							UpdateFilterGroup()
							UF:Update_AllFrames()
						end,
		...
		if
			not selectedSpell or not E.global.unitframe.aurafilters[selectedFilter].spells[(spellID or selectedSpell)]
		then
			E.Options.args.filters.args.spellGroup = nil
			return
		end
		...
		E.Options.args.filters.args.spellGroup = {
			...
			args = {
				enable = {
					...
					set = function(info, value)
						E.global.unitframe.aurafilters[selectedFilter].spells[(spellID or selectedSpell)].enable = value
						UpdateFilterGroup()
						UF:Update_AllFrames()
					end,
				},
				forDebuffIndicator = {
					...
					args = {
						priority = {
							...
							set = function(info, value)
								E.global.unitframe.aurafilters[selectedFilter].spells[(spellID or selectedSpell)].priority =
									value
								UpdateFilterGroup()
								UF:Update_AllFrames()
							end,
						...
						stackThreshold = {
							...
							set = function(info, value)
								E.global.unitframe.aurafilters[selectedFilter].spells[(spellID or selectedSpell)].stackThreshold =
									value
								UpdateFilterGroup()
								UF:Update_AllFrames()
							end,
...
E.Options.args.filters = {
	...
	args = {
		...
		deleteFilter = {
			...
			disabled = function()
				return G.unitframe.aurafilters[selectedFilter]
			end,
			hidden = function()
